        ...
        <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-bg-dark/95 backdrop-blur-md border-b border-white/10' : 'bg-transparent'}`}>
            <div className="container flex items-center justify-between h-full">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a href="https://wa.me/923037852007" target="_blank" rel="noopener noreferrer" className="btn btn-primary text-sm px-6 py-2 ml-4">
                        Contact Us
                    </a>
                </div>
                    ...
                    {isOpen && (
                        ...
                        >
                            <div className="flex flex-col p-6 gap-4">
                                ...
                                <a href="https://wa.me/923037852007" target="_blank" rel="noopener noreferrer" onClick={() => setIsOpen(false)} className="btn btn-primary w-full justify-center mt-4">
                                    Contact Us
                                </a>
                            </div>
                        </motion.div>
