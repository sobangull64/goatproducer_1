...
import { Instagram, Youtube, Smartphone, Mail } from 'lucide-react';
                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/goatproduces/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-black transition-colors">
                                <Instagram size={18} />
                            </a>
                            <a href="https://www.youtube.com/@GoatProduces" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-black transition-colors">
                                <Youtube size={18} />
                            </a>
                            <a href="https://www.tiktok.com/@goatproduces?_r=1&_t=ZS-92odkc6LJRv" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-primary hover:text-black transition-colors">
                                <Smartphone size={18} />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-text-muted">
                            <li className="flex items-center gap-2">
                                <a href="https://calendly.com/sayyam-goat7/30min" target="_blank" rel="noopener noreferrer" className="btn btn-primary text-xs px-4 py-2">Book a Call</a>
                            </li>
                        </ul>
                    </div>
                </div>
